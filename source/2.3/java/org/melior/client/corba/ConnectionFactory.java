...
/**
 * Implements a factory for persistent CORBA {@code Connection} objects.
 * @author Melior
 * @since 2.3
 */
public class ConnectionFactory<T extends IDLEntity> implements org.melior.client.core.ConnectionFactory<ClientConfig, Connection<T>, T> {
